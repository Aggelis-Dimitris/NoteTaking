...
namespace NoteTaking {
    ...
    public partial class SampleDatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class NotesDataTable : global::System.Data.TypedTableBase<NotesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NotesRow AddNotesRow(int Id, string Title, string Message) {
...
namespace NoteTaking.SampleDatabaseDataSet1TableAdapters {
    ...
    public partial class NotesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Notes] WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AN" +
                "D [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Message = 1 AND" +
                " [Message] IS NULL) OR ([Message] = @Original_Message)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Notes] ([Id], [Title], [Message]) VALUES (@Id, @Title, @Messag" +
                "e);\r\nSELECT Id, Title, Message FROM Notes WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Notes] SET [Id] = @Id, [Title] = @Title, [Message] = @Message WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Message = 1 AND [Message] IS NULL) OR ([Message] = @Original_Message)));
SELECT Id, Title, Message FROM Notes WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NoteTaking.Properties.Settings.Default.SampleDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, Message FROM dbo.Notes";
        ...
        public virtual int Fill(SampleDatabaseDataSet1.NotesDataTable dataTable) {
        ...
        public virtual SampleDatabaseDataSet1.NotesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDatabaseDataSet1.NotesDataTable dataTable = new SampleDatabaseDataSet1.NotesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDatabaseDataSet1.NotesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Message) {
        ...
        public virtual int Insert(int Id, string Title, string Message) {
        ...
        public virtual int Update(int Id, string Title, string Message, int Original_Id, string Original_Title, string Original_Message) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Message, int Original_Id, string Original_Title, string Original_Message) {
            return this.Update(Original_Id, Title, Message, Original_Id, Original_Title, Original_Message);
        }
    }
